...
export const OnBoardingScreen: NavigationScreenComponent = ({ navigation }) => {
	...
	return (
		<Animated.ScrollView
			pagingEnabled={true}
			onScroll={Animated.event([{ nativeEvent: { contentOffset: { y: yOffset } } }], { useNativeDriver: true })}
		...
		>
			...
			/>
			<Animated.Image
				source={require("../../assets/images/blueoval.png")}
				style={[styles.blueBubble, translationAnimation(-200)]}
			/>
			...
			<View style={styles.volumeview}>
				<TouchableOpacity onPress={() => SoundService.playSong(SoundService.cBieng)}>
					<Image style={styles.volume} source={require("../../assets/images/volume.png")} />
				</TouchableOpacity>
